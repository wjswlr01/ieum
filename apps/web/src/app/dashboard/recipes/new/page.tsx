...
export default function NewRecipePage() {
  ...
  return (
    <main className="px-4 py-6 md:px-12 md:py-10 max-w-2xl mx-auto w-full">
      ...
      {state.step === 1 && (
        <section>
          <h1 className="text-xl md:text-2xl font-bold mb-2">주종을 선택하세요</h1>
      ...
      {state.step === 2 && state.brewType && (
        <section>
          <h1 className="text-xl md:text-2xl font-bold mb-2">템플릿을 선택하세요</h1>
      ...
      {state.step === 3 && (
        <section>
          <h1 className="text-xl md:text-2xl font-bold mb-2">기본 정보 입력</h1>
      ...
      {state.step === 4 && (
        <section>
          <h1 className="text-xl md:text-2xl font-bold mb-2">공정 노드 확인</h1>
