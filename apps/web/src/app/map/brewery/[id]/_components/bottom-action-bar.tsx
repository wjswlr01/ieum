...
export default function BottomActionBar({
  ...
  function handleEditOwn() {
    // TODO: Phase 5-B에서 /dashboard/my-brewery 라우트 구현
    alert("양조장 정보 수정 페이지는 Phase 5-B에서 제공 예정입니다.");
  }

  return (
    <nav
      className="sticky bottom-0 z-30 border-t border-brew-border bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/75"
      aria-label="양조장 액션"
