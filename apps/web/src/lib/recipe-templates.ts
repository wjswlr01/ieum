...
export const MAKGEOLLI_TEMPLATES: RecipeTemplate[] = [
  {
    id: "mak-danyangju",
    name: "단양주",
    description: "한 번에 술밑을 넣어 완성하는 단일 발효 (발효 → 거르기 → 숙성 → 병입)",
    nodes: [
      { nodeType: "GRAIN_PREP", order: 1, name: "고두밥 준비", durationMin: 180 },
      { nodeType: "MASH", order: 2, name: "술 담기", durationMin: 60 },
      ...
      { nodeType: "FILTERING", order: 4, name: "거르기", durationMin: 120 },
      { nodeType: "CONDITIONING", order: 5, name: "숙성", durationMin: 10080, targetTemp: 4 },
      { nodeType: "PACKAGING", order: 6, name: "병입", durationMin: 60 },
    ],
  },
  {
    id: "mak-2dan",
    name: "이양주",
    description: "밑술 발효 후 덧술을 추가하는 2단 발효 (밑술 1회 + 덧술 1회 + 거르기/숙성/병입)",
    nodes: [
      ...
      { nodeType: "FERMENTATION", order: 6, name: "발효", durationMin: 10080, targetTemp: 20,
        extraParams: { durationDays: 7, measureInterval: "2일마다" } as FermentationParams },
      { nodeType: "FILTERING", order: 7, name: "거르기", durationMin: 120 },
      { nodeType: "CONDITIONING", order: 8, name: "숙성", durationMin: 10080, targetTemp: 4 },
      { nodeType: "PACKAGING", order: 9, name: "병입", durationMin: 60 },
    ],
  },
  {
    id: "mak-3dan",
    name: "삼양주",
    description: "밑술 + 1차·2차 덧술의 3단계 발효 (밑술 1회 + 덧술 2회 + 거르기/숙성/병입)",
    nodes: [
      { nodeType: "GRAIN_PREP", order: 1, name: "고두밥 준비 (1차)", durationMin: 180 },
      { nodeType: "MASH", order: 2, name: "밑술 담기", durationMin: 60 },
      { nodeType: "FERMENTATION", order: 3, name: "밑술 발효", durationMin: 4320, targetTemp: 25,
      ...
      { nodeType: "FERMENTATION", order: 9, name: "발효", durationMin: 10080, targetTemp: 20,
        extraParams: { durationDays: 7, measureInterval: "2일마다" } as FermentationParams },
      { nodeType: "FILTERING", order: 10, name: "거르기", durationMin: 120 },
      { nodeType: "CONDITIONING", order: 11, name: "숙성", durationMin: 14400, targetTemp: 4 },
      { nodeType: "PACKAGING", order: 12, name: "병입", durationMin: 60 },
    ],
  },
];
...
export const NODE_TYPE_META: Record<string, { label: string; color: string }> = {
  ...
  FILTERING: { label: "거르기", color: "cyan" },
