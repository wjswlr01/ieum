  ...
  const recipes = [
    {
      ...
      nodes: [
        ...
        {
          nodeType: "FILTERING" as const,
          order: 4,
          name: "거르기",
          description: "발효주를 체와 망으로 걸러 술과 지게미를 분리합니다. 필요 시 물을 추가합니다.",
          durationMin: 120,
        },
        {
          ...
          order: 5,
          name: "숙성",
          description: "저온(4°C 내외)에서 약 7일간 숙성하여 맛을 안정화합니다.",
          durationMin: 10080,
          targetTemp: 4,
          extraParams: { targetDays: 7 } as Record<string, unknown>,
        },
        {
          nodeType: "PACKAGING" as const,
          order: 6,
          name: "병입",
          description: "숙성된 술을 병에 옮겨 담습니다.",
          durationMin: 60,
        },
      ],
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          order: 8,
          name: "숙성",
          description: "저온(4°C 내외)에서 7~14일간 숙성하여 맛을 안정화합니다.",
          durationMin: 10080,
          targetTemp: 4,
          extraParams: { targetDays: 7 } as Record<string, unknown>,
        },
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          order: 11,
          name: "숙성",
          description: "저온(4°C 내외)에서 10~14일간 숙성하여 깊은 맛을 끌어냅니다.",
          durationMin: 14400,
          targetTemp: 4,
          extraParams: { targetDays: 10 } as Record<string, unknown>,
        },
        {
          nodeType: "PACKAGING" as const,
          order: 12,
